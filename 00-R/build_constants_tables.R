...
# write data objects
saveRDS(kvals, here::here('02-data', '00-source', 'van_wagtendonk', 'kvals.rds'))
saveRDS(litterduff_coeffs, here::here('02-data', '00-source', 'van_wagtendonk', 'litterduff_coeffs.rds'))
saveRDS(QMDcm, here::here('02-data', '00-source', 'van_wagtendonk', 'QMDcm.rds'))
saveRDS(SEC, here::here('02-data', '00-source', 'van_wagtendonk', 'SEC.rds'))
saveRDS(SG, here::here('02-data', '00-source', 'van_wagtendonk', 'SG.rds'))
saveRDS(species_codes, here::here('02-data', '00-source', 'van_wagtendonk', 'species_codes.rds'))
saveRDS(vw96_sg_1000r, here::here('02-data', '00-source', 'van_wagtendonk', 'vw96_sg_1000r.rds'))