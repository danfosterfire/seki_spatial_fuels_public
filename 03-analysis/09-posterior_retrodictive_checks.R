  ...
  do.call('bind_rows',
          lapply(X = 1:4000,
                 FUN = function(draw){
                   ...
                   results = 
                     data.frame(Y_obs = litter_training_data$Y,
                                Y_sim = Y,
                                group_id = 
...
saveRDS(litter_sim,
        here::here('02-data', '06-results', 'posterior_retrodictions',
                   'litter_sim.rds'))

litter_sim = 
  readRDS(here::here('02-data', '06-results', 'posterior_retrodictions',
                   'litter_sim.rds'))
...
1.71 / mean(litter_training_data$Y) # 0.356
...
litter_plot_2 = 
  ...
  theme_minimal()+
  labs(title = 'litter retrodiction')
...
litter_plot_4 = 
  ...
  geom_col(
    data = 
      ...
      summarise(count = n()) %>%
      ungroup(),
    aes(x = Y_obs, y = count, fill = 'Observed (training data)'),
    width = 0.5,
    alpha = 0.75
  )+
  scale_fill_manual(values = c('Observed (training data)' = 'red'))+
...
litter_plot_5 = 
  ...
  stat_ecdf(
    ...
    aes(x = Y_obs, color = 'Observed (training data)'),
    geom = 'step',
    pad = 'false',
    #color = 'red',
    lwd = 1
  ...
  theme_minimal()+
  scale_color_manual(values = c('Observed (training data)' = 'red', 'Simulated' = 'blue'))+
  facet_grid(group_id~.)+
  ...
  do.call('bind_rows',
          lapply(X = 1:4000,
                 FUN = function(draw){
                   ...
                   results = 
                     data.frame(Y_obs = duff_training_data$Y,
                                Y_sim = Y,
                                group_id = 
...
1.52 / mean(duff_training_data$Y)
...
duff_plot_1 = 
  ...
  labs(x = 'Mean simulated duff depth (cm)',
       y = 'Observed (training data) duff depth (cm)')

duff_plot_1

ggsave(duff_plot_1,
       filename = here::here('04-communication','figures', 'manuscript',
                             'duff_retrodiction_1.png'),
       height = 4, width = 6.5, units = 'in')
...
3.78/mean(fwdtallies_training_data$Y)
...
fwdtallies_plot_1 = 
  ...
  labs(x = 'Mean simulated FWD tally',
       y = 'Observed (training data) FWD tally')

fwdtallies_plot_1

ggsave(fwdtallies_plot_1,
       filename = here::here('04-communication','figures', 'manuscript',
                             'fwdtallies_retrodiction_1.png'),
       height = 4, width = 6.5, units = 'in')
...
fwdtallies_plot_2 = 
  ...
  facet_grid(group_id~., scales = 'free')+
  theme_minimal()+
  labs(title = 'fwdtallies retrodiction')+
          ...
          lapply(X = 1:4000,
                 FUN = 
                   function(draw){
                     ...
                     N = fwddiams_training_data$N
                     group_id = fwddiams_training_data$group_id
                     plot_id = fwddiams_training_data$plot_id
                     transect_id = fwddiams_training_data$transect_id
                   
                     logmu = 
                       sapply(X = 1:fwddiams_training_data$N,
                              FUN = function(i){
                     ...
                     results = 
                       data.frame(Yobs = fwddiams_training_data$Y,
...
fwddiams_plot_2 = 
  ...
  stat_ecdf(
    data = fwddiams_sim %>%
      ...
      summarise() %>%
      ungroup(),
    aes(x = Yobs, color = 'Observed (training data)'),
    lwd = 1,
    pad = FALSE
  )+
  facet_grid(group_id~.)+
...
cwdtallies_plot_1 = 
  ...
  labs(x = 'Mean simulated CWD tally',
       y = 'Observed (training data) CWD tally')

cwdtallies_plot_1

ggsave(cwdtallies_plot_1,
       filename = here::here('04-communication','figures', 'manuscript',
                             'cwdtallies_retrodiction_1.png'),
       height = 6.5, width = 6.5, units = 'in')
...
cwdtallies_plot_2 = 
  ...
  facet_grid(group_id~., scales = 'free')+
  theme_minimal()+
  labs(title = 'cwdtallies retrodiction')
          ...
          lapply(X = 1:4000,
                 FUN = 
                   function(draw){
                     ...
                     N = cwddiams_training_data$N
                     group_id = cwddiams_training_data$group_id
                     plot_id = cwddiams_training_data$plot_id
                     ...
                     results = 
                       data.frame(Yobs = cwddiams_training_data$Y,
                                  plot_id = plot_id,
  ...
  do.call('bind_rows',
          lapply(X = 1:4000,
                 FUN = function(draw){
                   ...
                   results = 
                     data.frame(Y_obs = vegpa_training_data$Y,
                                Y_sim = Y,
                                group_id = 
...
vegpa_retrodiction_1 = 
  ...
  ungroup() %>%
  ggplot()+
  geom_jitter(aes(x = r, y = Y_obs, color = 'Observed (training data)'), 
  ...
  geom_point(data = 
               ...
               summarise(r_loc = mean(r),
                         p.actual = mean(Y_obs)) %>%
               ungroup(),
             aes(x = r_loc, y = p.actual, color = 'Observed (training data)'),
             pch = 18, size = 3)+
  
  facet_grid(group_id~.)+
  theme_minimal()+
  labs(x = 'Rank (by probability of presence)', y = 'Presence of understory vegetation (training data)')+
  scale_color_manual(values = c('Observed (training data)' = 'red', 'Simulated' = 'blue'))+
  theme(legend.position = 'bottom',
        legend.title = element_blank())
...
ggsave(vegpa_retrodiction_1,
       filename = here::here('04-communication',
                             'figures',
                             'manuscript',
                             'vegpa_retrodiction_1.png'),
       height = 6.5, width = 6.5, units = 'in')
...
ggplot()+
  ...
  stat_ecdf(
    data = 
      ...
      ungroup(),
    aes(x = percent_cover, color = 'Observed (training data)'),
    geom = 'step',
    pad = 'false',
    #color = 'red',
    lwd = 1
  ...
  scale_color_manual(values = c('Observed (training data)' = 'red', 'Simulated' = 'blue'))+
  facet_grid(group_id~.)+
  labs(x = 'Plot-level % cover', y = 'Cumulative density', title = 'Veg pres/abs retrodiction')
  ...
  do.call('bind_rows',
          lapply(X = 1:4000,
                 FUN = function(draw){
                   ...
                   results = 
                     data.frame(Y_obs = trees_training_data$Y,
                                Y_sim = Y,
                                group_id = 
...
trees_plot_1 = 
  ...
  labs(x = 'Mean simulated tree tally',
       y = 'Observed (training data) tree tally')

trees_plot_1

ggsave(trees_plot_1,
       filename = here::here('04-communication','figures', 'manuscript',
                             'trees_retrodiction_1.png'),
       height = 4, width = 6.5, units = 'in')
...
trees_plot_6 = 
  ...
  stat_ecdf(
    data = 
      ...
      ungroup(),
    aes(x = tph, color = 'Observed (training data)'),
    geom = 'step', 
    lwd = 1
  )+
  scale_color_manual(values = c('Observed (training data)' = 'red','Simulated' ='blue'))+
  ...
  do.call('bind_rows',
          lapply(X = 1:4000,
                 FUN = function(draw){
                   ...
                   results = 
                     data.frame(Y_obs = saplings_training_data$Y,
                                Y_sim = Y,
                                group_id = 
...
saplings_plot_1 = 
  ...
  labs(x = 'Mean simulated sapling tally',
       y = 'Observed (training data) sapling tally')

saplings_plot_1

ggsave(saplings_plot_1,
       filename = here::here('04-communication','figures', 'manuscript',
                             'saplings_retrodiction_1.png'),
       height = 4, width = 6.5, units = 'in')
...
saplings_plot_2 = 
  ...
  facet_grid(group_id~., scales = 'free')+
  theme_minimal()+
  labs(title = 'saplings retrodiction')
...
0.263/mean(cwdtallies_training_data$Y)

# saplings mae 0.112
0.112/mean(saplings_training_data$Y)
# trees mae 0.096
0.096/mean(trees_training_data$Y)
